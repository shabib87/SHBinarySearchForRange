...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SHBinarySearchForRange.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SHBinarySearchForRange'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shabib87' => 'shabib.sust@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SHBinarySearchForRange.git', :tag => s.version.to_s }
